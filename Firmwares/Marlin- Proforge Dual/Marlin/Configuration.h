...
#define STRING_CONFIG_H_AUTHOR "(Makertech-3D)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Proforge Dual"
...
//#define HOTEND_OFFSET_X {0.0, 60.00} // (in mm) for each extruder, offset of the hotend on the X axis
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 143, 400, 240 }
