/**
  ...
  MAKERTECH 3D - CNC (Grbl) post processor configuration.
  This script is a modifacation of the generic GRBL post process.

  
  FORKID {154F7C00-6549-4c77-ADE0-79375FE5F2AA}
*/

description = "MAKERTECH CNC (Grbl)";
vendor = "MAKERTECH-3D";
vendorUrl = "http://www.makertech-3d.com";
legal = "Copyright (C) 2012-2015 by Autodesk, Inc.";
certificationLevel = 2;
minimumRevision = 24000;

longDescription = "Generic milling post for Proforge";
...
function onOpen() {
  ...
  writeln("Generic Milling code for Proforge - Generated with Fusion360 ");
  ...
  switch (unit) {
  case IN:
    error(localize("Please select millimeters as units."));
    return;
...
function onSection() {
  ...
  if (retracted || isFirstSection() || true) {
    gMotionModal.reset();
